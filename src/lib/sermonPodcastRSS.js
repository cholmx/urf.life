// Sermon Podcast RSS feed utility
export class SermonPodcastRSSService {
  constructor() {
  ...
  parseRSSFeed(xmlString) {
    try {
      ...
      const channelInfo = {
        ...
        description: this.getTextContent(channel, 'description') || 'Upper Room Fellowship Sermon Podcast',
      ...
      // Increased limit to 50 episodes (from 20)
  ...
  getFallbackData() {
    return {
      channel: {
        ...
        description: 'Welcome to the Sermon Podcast from Upper Room Fellowship. Join us as we explore faith, community, and living out God\'s love in our daily lives.',
        image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=400&h=400&fit=crop',
        link: 'https://anchor.fm/s/2fa685e0/podcast/rss',
        language: 'en',
      ...
      episodes: [
        {
          id: 'fallback-1',
          title: 'Welcome to our Sermon Podcast',
          description: 'In this sermon, we explore the foundations of faith and how we can apply biblical principles to our daily lives.',
          audioUrl: null,
          duration: '35:45',
          pubDate: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
          link: 'https://anchor.fm/s/2fa685e0',
          guid: 'fallback-guid-1',
          image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=400&h=400&fit=crop',
          summary: 'Welcome to our sermon podcast where we explore faith and scripture together.'
        }
      ],
      lastUpdated: new Date().toISOString(),
      isFallback: true
  ...
  getCachedEpisodes() {
    try {
      const cached = localStorage.getItem('sermon_podcast_cache')
      ...
      if (cacheAge > maxAge) {
        localStorage.removeItem('sermon_podcast_cache')
        return null
      }
...
export default new SermonPodcastRSSService()